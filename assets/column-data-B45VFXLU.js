...
`},{id:"mlcc-murata-analysis",category:"個別銘柄解説",tag:"電子部品",title:"村田製作所とMLCC：AI時代の「縁の下の力持ち」が世界を動かす",date:"2026-05-29",summary:"AIサーバー1台に使われるMLCC（積層セラミックコンデンサ）はスマートフォンの10〜20倍。世界シェアNo.1の村田製作所を軸に、MLCC産業の構造変化と日本の電子部品メーカーへの影響を徹底解説します。",body:`
