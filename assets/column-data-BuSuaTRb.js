const e=[{id:"theme-investing-basics",themes:["テーマ一覧"],keywords:["テーマ株","投資","入門","初心者"],category:"入門",icon:"📘",title:"テーマ株投資とは？個別株・インデックスとの違いをわかりやすく解説",date:"2026/03/20",summary:"「半導体関連株が急騰」「AI銘柄に資金集中」といったニュースを聞いたことがあるでしょう。テーマ株投資とは何か、メリット・リスクをゼロから解説します。",body:`
H2: テーマ株投資とは何か
...
> 免責事項：本コラムは情報提供目的のみです。特定銘柄の売買推奨ではありません。投資判断はご自身の責任でお願いします。`},{id:"spacex-analysis-en",themes:["宇宙・衛星","防衛・航空"],keywords:["SpaceX","SPCX","Elon Musk","Starlink","IPO","rocket","space investment","個別銘柄"],category:"個別銘柄",icon:"🚀",title:"SpaceX (SPCX) Deep Dive: History's Largest IPO & Japan Stock Impact",date:"2026/06/12",summary:"SpaceX listed on Nasdaq June 12, 2026 raising $75B at a $1.77T valuation — history's largest IPO. Analysis of business model, growth drivers, competitors, and Japanese stock opportunities.",body:`SpaceX (Space Exploration Technologies Corp.) was founded in 2002 by Elon Musk to reduce the cost of space transportation and ultimately enable human life on multiple planets.

H2: Business Model and Operations

SpaceX's defining advantage is vertical integration — designing and manufacturing its own rocket engines, airframes, electronics, ground systems, and software in-house. This has reduced launch costs by approximately 90% versus legacy providers.

The three core revenue streams:

Rocket Launch Services: Falcon 9, Falcon Heavy, and Starship carry commercial satellites, NASA crew, and military payloads. Over 160 launches in 2025 — more than all other global providers combined.

Starlink: Low Earth orbit satellite internet with 7,000+ satellites serving 7M+ users in 120+ countries. Residential plans start below $100/month. Premium aviation, maritime, and government plans command much higher ARPU.

Starship: Next-generation super-heavy launch vehicle targeting lunar missions, Mars colonization, and Earth-to-Earth transport (Tokyo to London in under 30 minutes). Selected by NASA for the Artemis lunar landing program.

H2: Historic IPO — June 12, 2026

The Nasdaq listing set records across every metric:
IPO price: $135/share (fixed-price structure)
Total raised: ~$75 billion (~$10.8 trillion JPY)
Market cap: ~$1.77 trillion (surpassed Toyota, Tesla, and Samsung on day one)
Oversubscription: 4x+ ($250B+ demand)
Retail allocation: 30% reserved for individual investors (industry norm is 5-10%)

The democratic fixed-price structure — triple to six times the normal retail allocation — reflected SpaceX's stated mission of making space investment accessible.

H2: Financial Profile

FY2025 revenue: ~$15 billion (+40% YoY)
- Starlink: ~$8.0B (54%)
- Launch services: ~$6.5B (43%)

EBITDA margin: ~25%

Starlink's growth potential is enormous. 7M subscribers represent a fraction of the addressable market (1B+ people lack reliable broadband globally). Aviation, maritime, and direct-to-device segments each represent multi-billion revenue opportunities. Some investment banks project Starlink revenues of $50B+ by 2030.

H2: Competitive Analysis

ULA (Boeing/Lockheed JV): Launch costs 3-5x SpaceX. Government-focused, limited commercial competitiveness. Vulcan Centaur under development.

Rocket Lab: Small satellite niche player. 90+ Electron launches. Cannot compete at scale with SpaceX. No satellite internet business.

Blue Origin (Jeff Bezos): Deep financial backing but significantly lags SpaceX in launch frequency and track record. No deployed satellite constellation.

China (CASC / Qianfan): Rapidly increasing launch cadence. Plans for 14,000-satellite constellation to rival Starlink. Geopolitical restrictions limit Western commercial market access.

SpaceX's durable moats: (1) reusable rocket IP requiring 20+ years of iteration, (2) 7,000+ satellite constellation as an orbital fait accompli, (3) 160+ annual launches creating unmatched reliability track record.

H2: Impact on Japanese Stocks

Space Theme Direct Beneficiaries:

IHI Corporation (7013): JAXA H3 rocket and satellite structural components. SpaceX's success expands global government space budgets — positive for Japan's space investment trajectory.

Mitsubishi Heavy Industries (7011): Japan's H-IIA rocket manufacturer. Overlaps with defense theme — double tailwind from both space and defense budget expansion.

Kawasaki Heavy Industries (7012): Aerospace structures and satellite components for JAXA and NASA-related programs.

SKY Perfect JSAT (9412): Faces some Starlink competition but focuses on enterprise/government high-reliability communications — a defensible niche.

Electronic Components Indirect Supply Chain:

Each Starlink satellite contains tens of thousands of passive electronic components. 1,000+ satellites manufactured annually makes SpaceX a significant demand driver for aerospace-grade components.

Murata Manufacturing (6981): World's largest MLCC maker. Aerospace-grade MLCCs carry premium margins.

TDK (6762): Electronic components in space-grade supply chain.

Taiyo Yuden (6976): MLCCs and inductors. Aerospace demand opportunity.

Sony Group (6758): CMOS image sensors used in satellite earth observation and optical inter-satellite links.

H2: Key Risk Factors

Elon Musk concentration risk: Strategy and investor sentiment deeply tied to one individual. Tesla, X, and Grok AI management bandwidth concerns. Public statements materially move SPCX price.

Regulatory risk: International orbital debris coordination. National security restrictions on Starlink deployment in certain geographies.

Technology risk: Starship commercialization timeline uncertainty. Major launch failure risk.

Valuation risk: $1.77T market cap at ~120x FY2025 revenue requires sustained high-growth assumptions. Multiple compression risk if growth decelerates.

H2: Investment Approach for Japanese Investors

Direct SPCX purchase: Open US brokerage account, buy SPCX on Nasdaq. Key considerations: USD/JPY currency risk, high initial volatility typical of newly-listed mega-cap stocks.

Japanese space and component stocks: IHI, Mitsubishi Heavy, Kawasaki, Murata, Sony — domestic exposure to space theme without currency risk. IHI and Mitsubishi Heavy benefit from both space and defense budget tailwinds.

Space remains a long-cycle industry. Long-term conviction and appropriate position sizing matter more than short-term price action.

> Disclaimer: This article is for informational purposes only and does not constitute investment advice. All investment decisions are made at your own risk.`}];export{e as C};
