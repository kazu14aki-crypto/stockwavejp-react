...
> **免責事項**: 本コラムは情報提供を目的としたものであり、特定銘柄の売買を推奨するものではありません。投資判断はご自身の責任においてお決めください。
`},{id:"spacex-analysis",themes:["宇宙・衛星","防衛・航空"],keywords:["SpaceX","SPCX","イーロン・マスク","Starlink","IPO","ロケット","個別銘柄"],category:"個別銘柄",icon:"🚀",title:"SpaceX(SPCX)徹底分析｜史上最大IPOの全貌と関連日本株",date:"2026/06/12",summary:"SpaceXが2026年6月12日にNasdaqに上場。調達額750億ドル・時価総額1.77兆ドルという史上最大のIPOを記録。ビジネスモデル・競合比較・関連日本株への影響を詳しく解説します。",body:`SpaceX（スペース・エクスプロレーション・テクノロジーズ）は、2002年にイーロン・マスク氏が設立した宇宙開発・輸送会社です。
...
> 免責事項：本コラムは情報提供目的のみです。特定銘柄の売買推奨ではありません。投資判断はご自身の責任でお願いします。`}];export{H as C};
