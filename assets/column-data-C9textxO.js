const H=[{id:"theme-selection-criteria",themes:["テーマ一覧"],keywords:["テーマ選定基準","構成銘柄","テーマ株","採用基準","除外基準","銘柄更新"],category:"入門",icon:"🧭",date:"2026/07/19",title:"StockWaveJPのテーマ選定基準：テーマと構成銘柄をどう決めているか",summary:"StockWaveJPが公式テーマを新設・統合し、構成銘柄を採用・除外する際の判断基準を公開します。テーマとの事業関連性、売上・利益への寄与、開示情報、流動性、重複掲載の扱い、定期見直しの方法を解説します。",body:`
H2: テーマ選定基準を公開する理由
