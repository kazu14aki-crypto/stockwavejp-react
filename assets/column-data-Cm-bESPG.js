const H=[{id:"major-shareholders-guide",themes:["テーマ一覧"],keywords:["大株主","有価証券報告書","EDINET","株主構成","創業家","機関投資家","信託口"],category:"入門",icon:"🏛️",date:"2026/07/04",title:"大株主を読めば企業がわかる：有価証券報告書「大株主の状況」の実践的な読み方",summary:"同じ業績でも株価の動き方が違うのはなぜか。答えは株主構成にあります。創業家・信託口・外国機関など株主の5類型の見分け方と、前期比較から資金の流れを読む方法を解説します。",body:`
