const H=[{id:"domestic-demand-defensive-theme-2026",themes:["内需・ディフェンシブ"],keywords:["内需","ディフェンシブ","個人消費","価格転嫁","生活必需品","実質所得"],category:"テーマ解説",icon:"🏠",date:"2026/08/09",title:"内需・ディフェンシブテーマを読み解く：景気に強い、だけでは足りない理由",summary:"国内需要を軸にし、景気変動の影響を比較的受けにくいとされる企業群を、需要の安定性、価格転嫁、賃金・物価、金利の観点から整理します。",body:`
H2: 内需・ディフェンシブとは何か
...
`},{id:"weak-yen-benefit-theme-2026",themes:["円安メリット"],keywords:["円安メリット","為替","輸出","海外売上","為替ヘッジ","輸入コスト"],category:"テーマ解説",icon:"💱",date:"2026/08/09",title:"円安メリットテーマを読み解く：輸出企業だけを買えばよい、ではない",summary:"円安は海外売上の円換算額を押し上げ得ますが、輸入原材料、海外生産、ヘッジ、価格競争力も同時に動きます。企業ごとの本当の為替感応度を確認する方法を解説します。",body:`
...
`},{id:"electric-utilities-theme-2026",themes:["電力会社"],keywords:["電力需要","脱炭素電源","送配電網","容量市場","電力料金","エネルギー基本計画"],category:"テーマ解説",icon:"⚡",date:"2026/08/09",title:"電力会社テーマを読み解く：AI時代の需要増、脱炭素投資、料金制度をどう見るか",summary:"電力会社は「安定配当」のイメージだけでは捉えきれない局面に入っています。需要の変化、発電構成、送配電網への投資、燃料価格と制度の関係を、投資判断の前提として整理します。",body:`
...
`},{id:"hydrogen-helium-water-resources-theme-2026",themes:["資源（水素・ヘリウム・水）"],keywords:["水素","ヘリウム","水資源","サプライチェーン","脱炭素","資源安全保障"],category:"テーマ解説",icon:"💧",date:"2026/08/09",title:"資源（水素・ヘリウム・水）テーマを読み解く：希少性より「使える供給網」を見る",summary:"水素、ヘリウム、水は性質も市場も異なりますが、共通するのは供給網、品質、設備、規制が価値を決める点です。話題性に流されず、社会実装の条件を整理します。",body:`
...
`},{id:"saas-theme-2026",themes:["SaaS"],keywords:["SaaS","DX","ARR","解約率","顧客獲得コスト","生成AI"],category:"テーマ解説",icon:"☁️",date:"2026/08/09",title:"SaaSテーマを読み解く：売上成長だけでは足りない、継続率と単価をどう見るか",summary:"SaaSは継続課金モデルの強みがある一方、顧客獲得コストと解約率が収益性を左右します。DX・生成AIの追い風を、実際のKPIに落として読むための基礎を解説します。",body:`
...
`},{id:"building-materials-theme-2026",themes:["建築資材"],keywords:["建築資材","セメント","鋼材","木材","住宅着工","価格転嫁"],category:"テーマ解説",icon:"🏗️",date:"2026/08/09",title:"建築資材テーマを読み解く：着工件数、価格転嫁、更新需要を一緒に見る",summary:"建築資材は住宅・非住宅・公共工事の需要に連動しますが、原材料・物流・エネルギーコストの影響も大きい分野です。数量と単価、更新投資の三層で読み解きます。",body:`
...
`},{id:"reuse-secondhand-theme-2026",themes:["リユース・中古品"],keywords:["リユース","中古品","循環経済","真贋","在庫回転","越境EC"],category:"テーマ解説",icon:"♻️",date:"2026/08/09",title:"リユース・中古品テーマを読み解く：成長の鍵は買取量ではなく、信頼と在庫回転",summary:"リユース市場は循環経済と節約志向の追い風を受けますが、買取、真贋、在庫、販売チャネルの運営力が収益性を分けます。小売とは異なる見方を整理します。",body:`
...
`},{id:"yen-intervention-japan-us-policy-2026",themes:["銀行・金融","内需・ディフェンシブ","円安メリット","石油","LNG","食品・飲料","輸送・物流"],keywords:["円買い介入","ドル円","日銀","財務省","米財務省","為替介入","日米協調","インフレ","原油","金利差"],category:"市場分析",icon:"💴",date:"2026/08/09",title:"2026年のドル円介入をわかりやすく読む：日米協調、物価高、金利差は何を意味するのか",summary:"2026年に続いた円買い介入と日米協調行動を、仕組み、家計・企業への影響、日米の政策事情、原油・金利・財政との関係、日本株で確認すべき点まで整理します。",body:`
...
> 免責事項：本コラムは一般的な情報提供を目的とし、特定銘柄の取得・売却・保有を推奨しません。為替、金利、原油、政策、企業業績は変動します。投資判断は最新の公式統計・企業開示等を確認し、ご自身の責任で行ってください。`},{id:"japan-current-policy-growth-strategy-2026",themes:["AI半導体","防衛・航空","原子力発電","国土強靭化計画","銀行・金融","造船"],keywords:["日本政策","高市内閣","日本成長戦略","責任ある積極財政","17分野"],category:"市場分析",icon:"🏛️",date:"2026/07/22",title:"2026年の日本政策を投資家目線で読む：高市内閣の成長戦略・積極財政・17分野",summary:"日本成長戦略を軸に、AI・半導体、防衛、エネルギー、造船、国土強靱化、賃金、地方、金融政策と国内外の関連企業を整理します。",body:`
...
- 防衛省「国家安全保障戦略・国家防衛戦略・防衛力整備計画」`},{id:"nvidia-japan-physical-ai-collaboration-2026",themes:["フィジカルAI・産業用ロボット","AI・クラウド","データセンター電力・冷却","自動運転"],keywords:["NVIDIA","エヌビディア","フィジカルAI","Cosmos","Noetra","Vera Rubin","富士通","ファナック","安川電機","川崎重工業","Toyota","SoftBank"],category:"市場分析",icon:"🤖",date:"2026/07/22",title:"NVIDIAと日本企業の大型協業を読み解く：フィジカルAI、Noetra、ロボット産業の勝機",summary:"NVIDIAのジェンスン・フアンCEO来日に合わせて発表された、日本企業とのフィジカルAI、国家規模AI基盤、ロボット、Toyota、SoftBank、業界特化AIの協業を整理し、日本企業の収益機会とリスクを分析します。",body:`
...
- 各参加企業の今後の適時開示、決算説明資料`},{id:"next-generation-semiconductors-history-present-future",themes:["次世代半導体"],keywords:["次世代半導体","過去","現在","未来","関連銘柄"],category:"産業・技術",icon:"🧪",date:"2026/07/22",title:"次世代半導体の過去・現在・未来：市場構造と関連銘柄を徹底解説",summary:"次世代半導体の歴史、現在の需要構造、将来シナリオ、関連銘柄、決算で確認すべき指標を整理します。",body:`
H2: 次世代半導体とは何か
...
> 免責事項：本コラムは一般的な情報提供を目的とし、特定銘柄の取得・売却・保有を推奨しません。記事公開後に制度、企業情報、市場環境が変化する場合があります。投資判断は最新の企業開示等を確認し、ご自身の責任で行ってください。`},{id:"fusion-power-history-present-future",themes:["核融合発電"],keywords:["核融合発電","過去","現在","未来","関連銘柄"],category:"エネルギー",icon:"☀️",date:"2026/07/22",title:"核融合発電の過去・現在・未来：市場構造と関連銘柄を徹底解説",summary:"核融合発電の歴史、現在の需要構造、将来シナリオ、関連銘柄、決算で確認すべき指標を整理します。",body:`
H2: 核融合発電とは何か
...
> 免責事項：本コラムは一般的な情報提供を目的とし、特定銘柄の取得・売却・保有を推奨しません。記事公開後に制度、企業情報、市場環境が変化する場合があります。投資判断は最新の企業開示等を確認し、ご自身の責任で行ってください。`},{id:"nuclear-power-history-present-future",themes:["原子力発電"],keywords:["原子力発電","過去","現在","未来","関連銘柄"],category:"エネルギー",icon:"⚛️",date:"2026/07/22",title:"原子力発電の過去・現在・未来：市場構造と関連銘柄を徹底解説",summary:"原子力発電の歴史、現在の需要構造、将来シナリオ、関連銘柄、決算で確認すべき指標を整理します。",body:`
H2: 原子力発電とは何か
...
> 免責事項：本コラムは一般的な情報提供を目的とし、特定銘柄の取得・売却・保有を推奨しません。記事公開後に制度、企業情報、市場環境が変化する場合があります。投資判断は最新の企業開示等を確認し、ご自身の責任で行ってください。`},{id:"quantum-computing-history-present-future",themes:["量子コンピューター"],keywords:["量子コンピューター","過去","現在","未来","関連銘柄"],category:"産業・技術",icon:"⚛️",date:"2026/07/22",title:"量子コンピューターの過去・現在・未来：市場構造と関連銘柄を徹底解説",summary:"量子コンピューターの歴史、現在の需要構造、将来シナリオ、関連銘柄、決算で確認すべき指標を整理します。",body:`
H2: 量子コンピューターとは何か
...
> 免責事項：本コラムは一般的な情報提供を目的とし、特定銘柄の取得・売却・保有を推奨しません。記事公開後に制度、企業情報、市場環境が変化する場合があります。投資判断は最新の企業開示等を確認し、ご自身の責任で行ってください。`},{id:"wearable-devices-history-present-future",themes:["ウェアラブル端末"],keywords:["ウェアラブル端末","過去","現在","未来","関連銘柄"],category:"消費・技術",icon:"⌚",date:"2026/07/22",title:"ウェアラブル端末の過去・現在・未来：市場構造と関連銘柄を徹底解説",summary:"ウェアラブル端末の歴史、現在の需要構造、将来シナリオ、関連銘柄、決算で確認すべき指標を整理します。",body:`
H2: ウェアラブル端末とは何か
...
> 免責事項：本コラムは一般的な情報提供を目的とし、特定銘柄の取得・売却・保有を推奨しません。記事公開後に制度、企業情報、市場環境が変化する場合があります。投資判断は最新の企業開示等を確認し、ご自身の責任で行ってください。`},{id:"coatings-industry-history-present-future",themes:["塗料"],keywords:["塗料","過去","現在","未来","関連銘柄"],category:"素材",icon:"🎨",date:"2026/07/22",title:"塗料の過去・現在・未来：市場構造と関連銘柄を徹底解説",summary:"塗料の歴史、現在の需要構造、将来シナリオ、関連銘柄、決算で確認すべき指標を整理します。",body:`
H2: 塗料とは何か
...
> 免責事項：本コラムは一般的な情報提供を目的とし、特定銘柄の取得・売却・保有を推奨しません。記事公開後に制度、企業情報、市場環境が変化する場合があります。投資判断は最新の企業開示等を確認し、ご自身の責任で行ってください。`},{id:"security-services-history-present-future",themes:["警備"],keywords:["警備","過去","現在","未来","関連銘柄"],category:"サービス",icon:"🛡️",date:"2026/07/22",title:"警備の過去・現在・未来：市場構造と関連銘柄を徹底解説",summary:"警備の歴史、現在の需要構造、将来シナリオ、関連銘柄、決算で確認すべき指標を整理します。",body:`
H2: 警備とは何か
...
> 免責事項：本コラムは一般的な情報提供を目的とし、特定銘柄の取得・売却・保有を推奨しません。記事公開後に制度、企業情報、市場環境が変化する場合があります。投資判断は最新の企業開示等を確認し、ご自身の責任で行ってください。`},{id:"wires-copper-history-present-future",themes:["電線・銅"],keywords:["電線・銅","過去","現在","未来","関連銘柄"],category:"素材・インフラ",icon:"🔌",date:"2026/07/22",title:"電線・銅の過去・現在・未来：市場構造と関連銘柄を徹底解説",summary:"電線・銅の歴史、現在の需要構造、将来シナリオ、関連銘柄、決算で確認すべき指標を整理します。",body:`
H2: 電線・銅とは何か
...
> 免責事項：本コラムは一般的な情報提供を目的とし、特定銘柄の取得・売却・保有を推奨しません。記事公開後に制度、企業情報、市場環境が変化する場合があります。投資判断は最新の企業開示等を確認し、ご自身の責任で行ってください。`},{id:"advanced-packaging-substrates-history-present-future",themes:["先端パッケージング・基板"],keywords:["先端パッケージング・基板","過去","現在","未来","関連銘柄"],category:"半導体",icon:"🧩",date:"2026/07/22",title:"先端パッケージング・基板の過去・現在・未来：市場構造と関連銘柄を徹底解説",summary:"先端パッケージング・基板の歴史、現在の需要構造、将来シナリオ、関連銘柄、決算で確認すべき指標を整理します。",body:`
H2: 先端パッケージング・基板とは何か
...
> 免責事項：本コラムは一般的な情報提供を目的とし、特定銘柄の取得・売却・保有を推奨しません。記事公開後に制度、企業情報、市場環境が変化する場合があります。投資判断は最新の企業開示等を確認し、ご自身の責任で行ってください。`},{id:"data-center-power-cooling-history-present-future",themes:["データセンター電力・冷却"],keywords:["データセンター電力・冷却","過去","現在","未来","関連銘柄"],category:"インフラ",icon:"❄️",date:"2026/07/22",title:"データセンター電力・冷却の過去・現在・未来：市場構造と関連銘柄を徹底解説",summary:"データセンター電力・冷却の歴史、現在の需要構造、将来シナリオ、関連銘柄、決算で確認すべき指標を整理します。",body:`
H2: データセンター電力・冷却とは何か
...
> 免責事項：本コラムは一般的な情報提供を目的とし、特定銘柄の取得・売却・保有を推奨しません。記事公開後に制度、企業情報、市場環境が変化する場合があります。投資判断は最新の企業開示等を確認し、ご自身の責任で行ってください。`},{id:"ma-business-succession-history-present-future",themes:["M&A・事業承継"],keywords:["M&A・事業承継","過去","現在","未来","関連銘柄"],category:"企業経営",icon:"🤝",date:"2026/07/22",title:"M&A・事業承継の過去・現在・未来：市場構造と関連銘柄を徹底解説",summary:"M&A・事業承継の歴史、現在の需要構造、将来シナリオ、関連銘柄、決算で確認すべき指標を整理します。",body:`
H2: M&A・事業承継とは何か
...
> 免責事項：本コラムは一般的な情報提供を目的とし、特定銘柄の取得・売却・保有を推奨しません。記事公開後に制度、企業情報、市場環境が変化する場合があります。投資判断は最新の企業開示等を確認し、ご自身の責任で行ってください。`},{id:"global-selloff-kospi-2026-july",themes:["AI半導体","メモリ","半導体製造装置","石油","LNG","銀行・金融"],keywords:["世界株安","KOSPI","韓国株","AIバブル","半導体株","SKハイニックス","サムスン電子","SOX指数","原油高","金利"],category:"分析手法",icon:"🌐",date:"2026/07/20",title:"世界株安はAI相場の終わりか：KOSPI急落から読み解く2026年7月の市場調整",summary:"2026年7月に世界を襲ったAI・半導体株安を、韓国KOSPIの急落、指数集中、レバレッジ、原油高、金利上昇から分析します。日本株の半導体・メモリ・装置株への影響と、下げ止まりを確認する指標も整理します。",body:`
...
> 免責事項：本記事は2026年7月20日時点の公開情報を基に、市場環境を整理したものです。特定の金融商品の売買を推奨するものではありません。市場状況や企業業績は変化するため、最新の決算、開示資料、株価、為替、金利を確認したうえで、ご自身の判断と責任で投資を行ってください。`},{id:"theme-selection-criteria",themes:["テーマ一覧"],keywords:["テーマ選定基準","構成銘柄","テーマ株","採用基準","除外基準","銘柄更新"],category:"入門",icon:"🧭",date:"2026/07/19",title:"StockWaveJPのテーマ選定基準：テーマと構成銘柄をどう決めているか",summary:"StockWaveJPが公式テーマを新設・統合し、構成銘柄を採用・除外する際の判断基準を公開します。テーマとの事業関連性、売上・利益への寄与、開示情報、流動性、重複掲載の扱い、定期見直しの方法を解説します。",body:`
H2: テーマ選定基準を公開する理由
...
> 免責事項：本基準はStockWaveJPの編集・分類方針を示すものであり、特定銘柄の売買を推奨するものではありません。テーマ構成や算出方法は、サービス改善やデータ提供条件の変更に伴い見直す場合があります。`},{id:"major-shareholders-guide",themes:["テーマ一覧"],keywords:["大株主","有価証券報告書","EDINET","株主構成","創業家","機関投資家","信託口"],category:"入門",icon:"🏛️",date:"2026/07/04",title:"大株主を読めば企業がわかる：有価証券報告書「大株主の状況」の実践的な読み方",summary:"同じ業績でも株価の動き方が違うのはなぜか。答えは株主構成にあります。創業家・信託口・外国機関など株主の5類型の見分け方と、前期比較から資金の流れを読む方法を解説します。",body:`
...
`},{id:"theme-investing-basics",themes:["テーマ一覧"],keywords:["テーマ株","投資","入門","初心者"],category:"入門",icon:"📘",title:"テーマ株投資とは？個別株・インデックスとの違いをわかりやすく解説",date:"2026/03/20",summary:"「半導体関連株が急騰」「AI銘柄に資金集中」といったニュースを聞いたことがあるでしょう。テーマ株投資とは何か、メリット・リスクをゼロから解説します。",body:`
H2: テーマ株投資とは何か
...
`},{id:"buffett-japan-stocks",themes:["バフェット銘柄"],keywords:["バフェット","総合商社","長期投資","価値投資"],category:"バフェット銘柄",icon:"🎩",date:"2026/03/27",title:"バークシャーの日本商社株投資：確認できる事実と投資上の論点",summary:"バークシャーの5大商社投資について、2026年時点の経営体制と一次資料に基づき整理します。",body:`H2: バークシャーの日本株投資
...
主な確認資料：Berkshire Hathaway株主向け年次書簡、各商社の大量保有報告書・IR資料。`},{id:"physical-ai-edge-ai",themes:["フィジカルAI","エッジAI","ロボット・自動化"],keywords:["フィジカルAI","エッジAI","ロボット","自律走行"],category:"フィジカルAI",icon:"🤖",date:"2026/03/26",title:"フィジカルAI・エッジAIとは？次世代AIが生む産業革命と日本企業の投資機会",summary:"生成AIがソフトウェアの世界を変えた次のステージとして「フィジカルAI」と「エッジAI」が注目されています。現実世界を動かすAIの台頭と日本企業の競争優位を解説します。",body:`
...
`},{id:"optical-communication",themes:["光ファイバー・光部品","IOWN","通信"],keywords:["光通信","光ファイバー","データセンター","AI","フォトニクス"],category:"光ファイバー・光部品",icon:"💡",date:"2026/03/23",title:"光ファイバー・光部品テーマ：AI・データセンター需要急増が生む光ファイバー・光部品市場の構造的拡大",summary:"生成AIの普及でデータ通信量が爆発的に増加しています。光ファイバー・光トランシーバー・光半導体など光通信インフラの需要急増と日本企業の強みを解説します。",body:`
H2: 光ファイバー・光部品テーマとは
...
`},{id:"iraq-geopolitics",themes:["防衛・航空","石油","LNG","レアアース・資源"],keywords:["イラク","中東","地政学","石油","原油"],category:"イラク",icon:"🌍",date:"2026/03/28",title:"中東・イラク情勢と日本株：確認すべきエネルギー経路とリスク",summary:"中東情勢を断定的な確率予測ではなく、ホルムズ海峡・エネルギー価格・企業コストへの波及経路から整理します。",body:`H2: イラク情勢を見る際の前提
...
主な確認資料：U.S. Energy Information Administration「World Oil Transit Chokepoints」、International Energy Agency「Strait of Hormuz」。`},{id:"renewable-energy-theme",category:"再生可能エネルギー",icon:"🌱",title:"再生可能エネルギーテーマ徹底解説：脱炭素政策が生む長期成長と主要銘柄・投資機会",date:"2026/04/04",themes:["再生可能エネルギー","太陽光発電","脱炭素・ESG","蓄電池"],keywords:["再生可能エネルギー","太陽光","風力","脱炭素","洋上風力","FIT","GX","ESG","電力"],summary:"政府のGX（グリーントランスフォーメーション）政策と2050年カーボンニュートラル目標を背景に、再生可能エネルギーテーマは長期的な成長が見込まれます。太陽光・洋上風力・水素など分野ごとの動向と国内主要銘柄の関係性を詳しく解説します。",body:`
H2: 再生可能エネルギーテーマとは
...
`},{id:"fujikura-analysis",category:"個別銘柄",icon:"🔌",title:"フジクラ（5803）徹底解説：光ファイバー・AI電力ケーブルで急成長する素材企業",date:"2026/04/11",themes:["光ファイバー・光部品","IOWN","AIデータセンター"],keywords:["フジクラ","5803","光ファイバー","電力ケーブル","データセンター","AI","海底ケーブル"],summary:"フジクラは光ファイバー・電力ケーブル・自動車用ワイヤーハーネスを手掛ける総合ケーブルメーカー。AI・データセンター需要の急増で光ファイバーと電力ケーブルの両輪が急成長。株価は2024年に年初比3倍超を記録した注目銘柄を徹底解説します。",body:`
H2: フジクラとはどんな会社か
...
`},{id:"furukawa-analysis",category:"個別銘柄",icon:"⚡",title:"古河電気工業（5801）徹底解説：光ファイバー・電力ケーブル・車載部品の総合電線メーカー",date:"2026/04/11",themes:["光ファイバー・光部品","EV・電気自動車","IOWN"],keywords:["古河電工","5801","光ファイバー","電力ケーブル","ワイヤーハーネス","EV","データセンター","銅"],summary:"古河電気工業（5801）は光ファイバー・電力ケーブル・自動車用ワイヤーハーネス・銅製品を手掛ける総合電線メーカー。AIデータセンター向け光ファイバー需要急増と洋上風力向け電力ケーブルという二大成長テーマを背景に株価が上昇。競合のフジクラ・住友電工とともに光ファイバー・光部品テーマの中核銘柄を徹底解説します。",body:`
H2: 古河電気工業とはどんな会社か
...
`},{id:"nittobo-analysis",category:"個別銘柄",icon:"🧵",title:"日東紡績（3110）徹底解説：ガラス繊維世界4位・防音材・住宅建材で独自ポジションを築く素材メーカー",date:"2026/04/11",themes:["光ファイバー・光部品","建築資材"],keywords:["日東紡績","3110","ガラス繊維","防音材","グラスウール","建材","医薬","情報通信"],summary:"日東紡績（3110）はガラス繊維（グラスウール）を中核とした素材メーカーで、防音・断熱建材・ガラスクロス・情報通信部品・医薬用途まで多角展開。国内断熱材市場での強固なポジションと、世界的なガラス繊維需要に支えられた成長ストーリーを徹底解説します。",body:`
H2: 日東紡績とはどんな会社か
...
`},{id:"murata-seisakusho-analysis",category:"個別銘柄",tag:"電子部品",title:"村田製作所（6981）徹底分析：時価総額14兆円を突破した電子部品の巨人の実力と今後",date:"2026/05/29",summary:"京都発祥の電子部品メーカー・村田製作所が2026年5月、時価総額14兆円を突破して任天堂を抜いて京都No.1企業となりました。世界最強の「材料技術」を武器に、AI・EV時代をどう勝ち抜くのか。業績・戦略・リスクを徹底分析します。",body:`
## 村田製作所とはどんな会社か
...
`},{id:"mlcc-murata-analysis",category:"テーマ",tag:"MLCC・電子部品",theme:"MLCC・電子部品",themes:["MLCC・電子部品"],title:"MLCC（積層セラミックコンデンサ）産業分析：AI・EV時代の最重要部品と日本電子部品メーカーへの影響",date:"2026/05/29",summary:"AIサーバー1台に使われるMLCC（積層セラミックコンデンサ）はスマートフォンの10〜20倍。世界シェアNo.1の村田製作所を軸に、MLCC産業の構造変化と日本の電子部品メーカーへの影響を徹底解説します。",body:`
...
> **免責事項**: 本コラムは情報提供を目的としたものであり、特定銘柄の売買を推奨するものではありません。投資判断はご自身の責任においてお決めください。
`},{id:"spacex-analysis",themes:["宇宙・衛星","防衛・航空"],keywords:["SpaceX","SPCX","イーロン・マスク","Starlink","IPO","ロケット","個別銘柄"],category:"個別銘柄",icon:"🚀",title:"SpaceX（SPCX）IPO分析：一次資料で確認できる事実とリスク",date:"2026/06/12",summary:"SpaceXの2026年IPOについて、SEC・会社発表で確認できる条件と投資上の論点を整理します。",body:`SpaceXは2002年に設立された宇宙輸送・衛星通信企業です。2026年6月12日にNasdaqおよびNasdaq TexasへSPCXとして上場しました。
...
主な確認資料：SpaceX IPO発表、SEC Form 424B4およびFree Writing Prospectus、Nasdaq上場情報。`}];export{H as C};
