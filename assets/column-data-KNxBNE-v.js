const H=[{id:"yen-intervention-japan-us-policy-2026",themes:["銀行・金融","内需・ディフェンシブ","円安メリット","石油","LNG","食品・飲料","輸送・物流"],keywords:["円買い介入","ドル円","日銀","財務省","米財務省","為替介入","日米協調","インフレ","原油","金利差"],category:"市場分析",icon:"💴",date:"2026/08/09",title:"2026年のドル円介入をわかりやすく読む：日米協調、物価高、金利差は何を意味するのか",summary:"2026年に続いた円買い介入と日米協調行動を、仕組み、家計・企業への影響、日米の政策事情、原油・金利・財政との関係、日本株で確認すべき点まで整理します。",body:`
