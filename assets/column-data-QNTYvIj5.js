const H=[{id:"electric-utilities-theme-2026",themes:["電力会社"],keywords:["電力需要","脱炭素電源","送配電網","容量市場","電力料金","エネルギー基本計画"],category:"テーマ解説",icon:"⚡",date:"2026/08/09",title:"電力会社テーマを読み解く：AI時代の需要増、脱炭素投資、料金制度をどう見るか",summary:"電力会社は「安定配当」のイメージだけでは捉えきれない局面に入っています。需要の変化、発電構成、送配電網への投資、燃料価格と制度の関係を、投資判断の前提として整理します。",body:`
