const H=[{id:"japan-current-policy-growth-strategy-2026",themes:["AI半導体","防衛・航空","原子力発電","国土強靭化計画","銀行・金融","造船"],keywords:["日本政策","高市内閣","日本成長戦略","責任ある積極財政","17分野"],category:"市場分析",icon:"🏛️",date:"2026/07/22",title:"2026年の日本政策を投資家目線で読む：高市内閣の成長戦略・積極財政・17分野",summary:"日本成長戦略を軸に、AI・半導体、防衛、エネルギー、造船、国土強靱化、賃金、地方、金融政策と国内外の関連企業を整理します。",body:`
