...
export default function Compare() {
  ...
  const [selMacro,   setSelMacro]   = useState(['譌･邨悟ｹｳ蝮・, 'S&P500', '繝峨Ν蜀・])
  ...
  return (
    <div style={{ padding: '28px 32px 48px' }}>
      ...
      <p style={{ fontSize: '12px', color: 'var(--text3)', marginBottom: '20px' }}>
        繝・・繝樣ｨｰ關ｽ邇・・豈碑ｼ・・・繝槭け繝ｭ謖・ｨ吶→縺ｮ蟇ｾ豈・      </p>
      ...
      {/* 繝・・繝樊ｯ碑ｼ・*/}
      <div style={sHead}>
        <span style={sTitle}>繝・・繝樊ｯ碑ｼ・/span>
        <div style={sLine} />
      </div>
      ...
      <div style={{ ...sHead, marginTop: '32px' }}>
        <span style={sTitle}>繝槭け繝ｭ豈碑ｼ・/span>
        <div style={sLine} />
      </div>
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: '6px', marginBottom: '16px' }}>
        {macroNames.map(t => (
