  ...
  return (
    <div style={{ padding: '28px 32px 48px' }}>
      ...
      <p style={{ fontSize: '12px', color: 'var(--text3)', marginBottom: '20px' }}>
        荳頑・繝・・繝・vs 荳玖誠繝・・繝槭・鬨ｰ關ｽ蟷・ｒ豈碑ｼ・ゅ←縺ｮ繝・・繝槭↓雉・≡縺碁寔縺ｾ縺｣縺ｦ縺・ｋ縺区滑謠｡縺ｧ縺阪∪縺吶・      </p>
      ...
      {loading ? <Loading /> : error ? (
        ...
        <>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px', marginTop: '24px' }} className="flow-grid">
            <div>
              <div style={sectionHead}>
                <span style={sectionTitle}>櫨 雉・≡豬∝・ TOP10</span>
            ...
            <div>
              <div style={sectionHead}>
                <span style={sectionTitle}>笶・ｸ・雉・≡豬∝・ TOP10</span>
                <div style={sectionLine} />
              </div>
          ...
          {/* 蜈ｨ繝・・繝・*/}
          <div style={sectionHead}>
            <span style={sectionTitle}>蜈ｨ繝・・繝・鬨ｰ關ｽ邇・ｸ隕ｧ</span>
            <div style={sectionLine} />
          </div>
