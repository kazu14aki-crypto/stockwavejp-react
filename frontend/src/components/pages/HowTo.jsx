...
const SECTIONS = [
  ...
  },
  {
    ...
    title: 'テーマ一覧',
    color: '#ff5370',
    summary: '全30テーマの騰落率・出来高・売買代金を比較',
    detail: {
      overview: 'テーマ一覧は、日本株の主要30テーマを横断比較できるページです。「今どのテーマに資金が集まっているか」を一目で判断するための核心ページです。',
      features: [
        {
          name: '期間選択',
        ...
        },
        {
          ...
          desc: '全30テーマの騰落率・出来高・売買代金を横棒グラフで表示。テーマ名が左に表示されるため、どのテーマかが一目でわかります。',
        },
      ],
      tips: [
  ...
  },
  {
    ...
    title: 'テーマ別詳細',
    color: '#aa77ff',
    summary: '特定テーマの構成銘柄・寄与度・比較グラフを詳細分析',
    detail: {
      ...
      features: [
        ...
        {
          name: '構成銘柄一覧テーブル',
          desc: '証券コード・銘柄名・株価・騰落率・大分類・小分類・寄与度・出来高・売買代金を一覧表示。「寄与度」はテーマ平均騰落率への各銘柄の貢献度です。',
        },
        {
          name: 'テーマ比較グラフ',
      ...
      tips: [
        'テーマ全体は上昇でも、構成銘柄の中で特定の1〜2銘柄だけが上昇している場合は「見かけ上の上昇」の可能性があります。寄与度を確認しましょう。',
  ...
  },
  {
    ...
    detail: {
      ...
      features: [
        ...
        {
          name: '構成銘柄テーブル',
          desc: '順位・証券コード・銘柄名・株価・騰落率・大分類・小分類・寄与度・出来高・売買代金を一覧表示。横スクロールで全カラムを確認できます。',
        },
      ],
      tips: [
  ...
  },
  {
    ...
    title: 'ヒートマップ',
    color: '#ff8c42',
    summary: 'テーマのパフォーマンスを色で一目把握',
    detail: {
      overview: '30テーマの騰落率を色（赤=上昇・緑=下落）で表示するヒートマップです。「どのテーマがいつ強かったか」を視覚的に把握できます。',
      features: [
        {
          name: '期間別ヒートマップ（1W/1M/3M/6M/1Y）',
          desc: '5つの期間の騰落率を横に並べて表示。1週間は短期トレンド、1年は長期トレンドの確認に使います。同一テーマが複数期間で赤い場合は長期的な上昇トレンドにあります。',
        },
        {
          name: '月次ヒートマップ',
  ...
  },
  {
    ...
    title: '資金フロー・騰落モメンタム',
    color: '#ffd166',
    summary: '資金の流れと加速・失速の状態を把握',
    detail: {
      overview: '「資金フロー」と「騰落モメンタム」の2タブで構成。資金がどのテーマに向かっているか、そのトレンドが強まっているか弱まっているかを確認できます。',
      features: [
        {
          name: '資金フロータブ：流入/流出TOP10',
          desc: '騰落率上位10テーマ（資金流入）と下位10テーマ（資金流出）を横棒グラフで表示。どのテーマへの資金集中が起きているか一目でわかります。',
        },
        {
          name: '資金フロータブ：全テーマ一覧',
          desc: '全30テーマの騰落率を降順で表示。資金の分布状況（上昇・下落のバランス）を把握できます。',
        },
        {
          name: '騰落モメンタムタブ',
  ...
  },
  {
    ...
    detail: {
      overview: '既存の30テーマに含まれない銘柄で独自のテーマを作成し、騰落率を追跡できます。自分の保有銘柄のグループや、特定のサプライチェーン関連銘柄をまとめて管理するのに最適です。',
      features: [
        {
          name: 'テーマ作成',
          desc: 'テーマ名を入力し、4桁の証券コード（例：6954）または銘柄名で検索して銘柄を追加します。複数の銘柄をまとめてオリジナルテーマとして保存できます。',
        },
        {
          name: '騰落率の自動計算',
...
const USAGE_SCENARIOS = [
  ...
  },
  {
    ...
    steps: [
      ...
      '資金フロー・騰落モメンタムでモメンタムの持続性を確認',
      '構成銘柄テーブルで寄与度の高い銘柄を特定',
    ],
  },
  {
    title: '📊 市場全体の地合い判断',
  ...
  return (
    <div style={{ padding: '28px 32px 48px' }}>
      ...
      {[
        ...
        {
          q: '期間選択（1日・1週間・1ヶ月など）の違いは何ですか？',
          a: '各期間の開始日から直近終値までの騰落率を表示します。「1日」は直近1営業日分、「1週間」は過去5営業日分が対象です。デフォルト表示は「1日」です。グラフの横軸もそれぞれの期間に対応した日付が表示されます。',
        },
        {
        ...
        },
        {
          ...
          a: 'カスタムテーマはサイドメニューの「カスタムテーマ」から自分だけのテーマを作成できる機能です。Googleアカウントでログインするとクラウドに保存されマルチデバイスで同期できます。未ログインの場合はブラウザのローカルストレージに保存されます。カスタムテーマはテーマ一覧・テーマ別詳細にも表示されます。',
        },
        {
          q: '市場別詳細ページの見方を教えてください。',
          a: '国内主要株・国内全般・市場区分（プライム・スタンダード・グロース）の3つのタブで切り替えられます。各タブ内でセグメント（業種）を選ぶと、そのセグメントに含まれる銘柄の騰落率・出来高・売買代金を確認できます。期間も1日〜1年で切り替え可能です。',
        },
        {
        ...
        {
          q: '資金フローのTOP5とは何ですか？',
          a: '全テーマのうち騰落率が上位5位（プラスのみ）・下位5位（マイナスのみ）のテーマを表示しています。上昇テーマ数・下落テーマ数も合わせて表示されます。市場全体の資金の流れを把握するのに活用してください。',
        },
        {
          q: '米国株や外国株は追跡できますか？',
