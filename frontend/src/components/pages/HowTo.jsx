const SECTIONS = [
  {
    icon: '🏠',
    title: 'ホーム',
    body: 'マーケットサマリー（上昇テーマ数・平均騰落率・資金流入TOP）とマクロ指標カード、マクロ比較グラフを表示します。サイト全体の概況をひと目で把握できます。',
  },
  {
    icon: '📊',
    title: 'テーマ一覧',
  ...
  },
  {
    icon: '🔍',
    title: 'テーマ別詳細',
    body: 'テーマを選択して構成銘柄の騰落率・寄与度・出来高・売買代金などの詳細を確認できます。ページ上部に平均騰落率・先月比・状態を表示。ページ下部にはテーマ比較・マクロ比較グラフも表示します。',
  },
  {
    icon: '📋',
    title: '市場別ランキング',
    body: '国内主要株（技術/素材/資本財/消費/金融/運輸）、国内全般（Core30/Large70相当）、プライム/スタンダード/グロース市場別の騰落率と構成銘柄一覧を表示します。',
  },
  {
    icon: '🔥',
    title: 'ヒートマップ',
  ...
  },
  {
    icon: '💹',
    title: '資金フロー・騰落モメンタム',
    body: '「資金フロー」タブでは資金流入TOP10・流出TOP10と全テーマの騰落率一覧を表示します。「騰落モメンタム」タブでは騰落率に加えて先週比・状態（加速/失速/転換）を確認できます。',
  },
  {
    icon: '🎨',
    title: 'カスタムテーマ',
    body: '独自のテーマを作成して追跡できます。4桁の証券コード（例：6954）または銘柄名で検索して好きな銘柄を組み合わせたオリジナルテーマを作成・編集・削除できます。',
  },
  {
    icon: '⚙️',
    title: '設定',
    body: 'カラーテーマ（ブラック/ネイビー/ホワイト）とPC/スマホの表示モード切替ができます。設定はブラウザに保存されリロードなしで即時反映されます。',
  },
]
