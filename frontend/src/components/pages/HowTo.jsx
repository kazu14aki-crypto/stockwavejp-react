...
const SECTIONS = [
  ...
  },
  {
    ...
    title: 'ヒートマップ',
    color: '#ffd166',
    summary: '資金フロー散布図・ヒートマップで67テーマを多角分析',
    detail: {
      overview: '4つのタブで構成。「📊ヒートマップ（資金フロー散布図）」が最初に表示されます。67テーマの騰落率・出来高・売買代金を散布図・ヒートマップで多角的に分析できます。',
      features: [
        {
          name: '📊 ヒートマップ（資金フロー散布図）★デフォルト表示',
  ...
  return (
    <div style={{ padding: '28px 32px 48px', maxWidth: '900px', margin: '0 auto' }}>
      ...
      {[
        ...
        {
          q: 'ヒートマップページを開くと最初に何が表示されますか？',
          a: '「📊 ヒートマップ（資金フロー散布図）」が最初に表示されます。X軸が騰落率、Y軸が出来高急増率、円の大きさが売買代金を表すバブルチャートです。右上の「注目ゾーン」に位置する大きな円が今週最も資金が集まっているテーマです。期間別ヒートマップや月次ヒートマップを見たい場合はタブを切り替えてください。',
        },
        {
