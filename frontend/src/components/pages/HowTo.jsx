      ...
      {[
        {
          ...
          a: '平日の9時5分頃〜15時40分頃まで、1時間おきに最大8回、GitHub Actionsにより自動更新されます。土日・祝日は更新されません。ヘッダーの「最終取得」で最新のデータ取得時刻を確認できます。',
        },
        {
          q: '表示されているデータはリアルタイムですか？',
          a: 'いいえ。データは信頼できるデータプロバイダより取得しており、15〜20分程度の遅延があります。また、日次更新のため、取引時間中のリアルタイム価格ではなく当日または前日の終値を基準に集計されます。実際の売買には証券会社の公式データをご使用ください。',
        },
        {
        ...
        },
        {
          ...
          a: 'X（旧Twitter）@StockWaveJP のDMまでご連絡ください。データプロバイダに起因する誤りの場合は修正が困難な場合もありますが、内容を確認の上対応いたします。',
        },
      ].map((item, i) => (
