export default function LegalNotice() {
  ...
  return (
    <div style={s}>
      ...
      <h2 style={h2}>無料体験</h2>
      <p style={p}>料金プランページで利用者が「ログインしてプロプラン無料体験する」または「プロプラン無料体験を開始する（14日間）」を選択した日から14日間、プロプラン相当の機能を無料でお試しいただけます（アカウントごとに1回）。無料体験にクレジットカードの登録は不要で、体験期間終了により自動的に課金されることはありません。</p>
      ...
      <p style={{ fontSize:'11px', color:'var(--text3)', marginTop:'24px' }}>最終更新日: 2026年8月9日 · バージョン: 2026-08-09</p>
    </div>
  )
}
