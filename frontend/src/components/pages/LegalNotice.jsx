export default function LegalNotice() {
  ...
  return (
    <div style={s}>
      ...
      <h2 style={h2}>無料体験</h2>
      <p style={p}>料金プランページで利用者が無料体験を開始した日から14日間、プロプラン相当の機能を無料でお試しいただけます（アカウントごとに1回）。無料体験にクレジットカードの登録は不要で、体験期間終了により自動的に課金されることはありません。</p>
      ...
      <p style={{ fontSize:'11px', color:'var(--text3)', marginTop:'24px' }}>最終更新日: 2026年8月4日 · バージョン: 2026-08-04</p>
    </div>
  )
}
