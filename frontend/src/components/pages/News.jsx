...
// 手動更新のお知らせリスト（新しい順）
const MANUAL_NEWS = [
  { date:'2026/05/19', title:'機関投資家大量保有情報ページを追加', body:'金融庁EDINETの大量保有報告書データを活用した「機関投資家大量保有情報」ページを追加しました。銘柄で検索して、どの機関投資家が何%保有しているか・保有割合の変遷が確認できます。毎日自動更新されます。' },
  { date:'2026/05/15', title:'週次レポート（5/11〜5/15）公開', body:'5/11〜5/15週の週次マーケットレポートを公開しました。防衛・セキュリティ（+11.2%）・宇宙・衛星（+9.8%）・半導体製造装置（+8.6%）が上位。テーマ平均+2.84%の強い週となりました。' },
  { date:'2026/05/08', title:'週次レポート（5/4〜5/8）公開', body:'GW明け全面高の5/4〜5/8週レポートを公開。半導体製造装置（+12.4%）・AI半導体（+11.8%）が急騰。テーマ平均+3.12%の力強い週。' },
  { date:'2026/05/01', title:'週次レポート（4/27〜5/1）公開', body:'4/27〜5/1週の週次マーケットレポートを公開しました。SaaS・生成AI・サイバーセキュリティが上昇。GW前の短縮週でもAI系テーマが好調。' },
  { date:'2026/05/18', title:'カスタムテーマに取得価格・損益管理機能を追加', body:'カスタムテーマに登録した銘柄に取得価格を入力することで、現在価格との比較による損益率・損益額をリアルタイム表示できるようになりました。' },
