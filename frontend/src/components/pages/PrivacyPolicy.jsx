  ...
  return (
    <div style={{ padding:'28px 32px 60px', maxWidth:'760px', margin:'0 auto' }}>
      ...
      {[
        ...
        {
          title: '3. Cookieの使用',
          body: '当サイトは、ユーザー体験の向上および利用状況の分析を目的として、Cookieを使用しています。\n\n・Google Analytics：サイトの利用状況を分析するために使用します。\n・Google AdSense：広告配信の最適化のために使用します。\n\nブラウザの設定によりCookieを無効にすることができますが、一部の機能が正常に動作しなくなる場合があります。',
        },
        {
          title: '4. 広告について',
          body: '当サイトは、GoogleのAdSenseサービスおよびA8.netアフィリエイトプログラムを利用しています。これらのサービスはCookieを使用してユーザーの興味に基づいた広告を配信します。広告収入はサービスの継続・改善のために使用されます。',
        },
        {
          title: '5. アフィリエイト広告について',
          body: '当サイトはA8.netをはじめとするアフィリエイトプログラムに参加しています。当サイトのリンクを経由して商品・サービスをご購入いただいた場合、当サイトに報酬が支払われることがあります。広告主から特定の商品・サービスの推奨を依頼されることは一切なく、掲載している広告はユーザーの投資判断に影響を与えることを目的としたものではありません。',
        },
        {
          title: '6. アクセス解析ツール',
          body: '当サイトではGoogleアナリティクスを使用しています。トラフィックデータは匿名で収集されており、個人を特定するものではありません。',
        },
        {
          title: '7. 免責事項',
          body: '当サイトに掲載されている情報は、その正確性・完全性を保証するものではありません。当サイトの情報を参考にして生じたいかなる損害についても、当サイト運営者は一切責任を負いません。',
        },
        {
