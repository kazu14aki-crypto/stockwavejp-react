...
const ALL_NEWS = [
  { date:'2026/05/20', tag:'NEW',    title:'週次レポート（5/11〜5/15）公開・注目銘柄ピックアップ追加' },
  { date:'2026/05/19', tag:'NEW',    title:'機関投資家大量保有情報ページを追加' },
  { date:'2026/05/18', tag:'UPDATE', title:'カスタムテーマに取得価格・損益管理機能を追加' },
  { date:'2026/05/08', tag:'NEW',    title:'週次レポート（5/4〜5/8）GW明け全面高を公開' },
  { date:'2026/05/01', tag:'NEW',    title:'週次レポート（4/27〜5/1）公開' },
  { date:'2026/04/19', tag:'NEW',    title:'週次レポート機能追加（毎週自動生成）' },
  { date:'2026/04/01', tag:'UPDATE', title:'コラム67本・個別銘柄解説を追加' },
