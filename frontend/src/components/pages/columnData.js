...
StockWaveJPでは毎日の自動更新データを通じて、エネルギー・防衛・輸送テーマの動向変化を更新データで確認できます。中東情勢が動いた時に「どのテーマが反応しているか」を素早く把握するツールとしてご活用ください。
...
`,
  },
  {
    ...
    category: '個別銘柄',
    icon: '🚀',
    title: 'SpaceX(SPCX)徹底分析｜史上最大IPOの全貌と関連日本株',
    date: '2026/06/12',
    summary: 'SpaceXが2026年6月12日にNasdaqに上場。調達額750億ドル・時価総額1.77兆ドルという史上最大のIPOを記録。ビジネスモデル・競合比較・関連日本株への影響を詳しく解説します。',
    body: `SpaceX（スペース・エクスプロレーション・テクノロジーズ）は、2002年にイーロン・マスク氏が設立した宇宙開発・輸送会社です。

H2: SpaceXのビジネスモデルと事業構造
