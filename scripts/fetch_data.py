...
def financial_fields(metrics, ticker, market_cap):
    ...
    return {
        ...
        "revenue_type": metric.get("revenue_type"),
        "operating_income": metric.get("operating_income"),
        "ordinary_income": metric.get("ordinary_income"),
        "net_income_parent": metric.get("net_income_parent"),
        "eps": metric.get("eps"),
        "eps_diluted": metric.get("eps_diluted"),
        "prior_revenue": metric.get("prior_revenue"),
        "prior_eps": metric.get("prior_eps"),
        "total_shares_issued": metric.get("total_shares_issued"),
        "treasury_stock_shares": metric.get("treasury_stock_shares"),
        "shares_outstanding": metric.get("shares_outstanding"),
        "average_shares": metric.get("average_shares"),
        "forecast_revenue": metric.get("forecast_revenue"),
        "forecast_operating_income": metric.get("forecast_operating_income"),
        "forecast_ordinary_income": metric.get("forecast_ordinary_income"),
